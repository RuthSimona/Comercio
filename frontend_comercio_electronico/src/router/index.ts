        ...
        children: [
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Productos", "Todos"],
              pageTitle: "Productos",
            },
          },
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Productos", "Crear"],
              pageTitle: "Productos",
            },
          },
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Productos", "Editar"],
              pageTitle: "Productos",
            },
          },
        ],
        ...
        children: [
          {
            path: "ver",
            name: "categorias-ver",
            component: () => import("@/views/categories/AllCategory.vue"),
            meta: {
              breadcrumbs: ["Administración", "Categoría", "Todos"],
          ...
          },
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Categoría", "Crear"],
              pageTitle: "Categorias",
            },
          },
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Categoría", "Editar"],
              pageTitle: "Categorias",
            },
          },
        ],
        ...
        children: [
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Usuarios", "Todos"],
              pageTitle: "Usuarios",
            },
          },
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Usuarios", "Crear"],
              pageTitle: "Usuarios",
            },
          },
          {
        ...
        children: [
          {
            ...
            meta: {
              breadcrumbs: ["Administración", "Ventas", "Todas"],
              pageTitle: "Ventas",
            },
          },
          {
            path: "detalles/:codeOrder",
            name: "editar-usuarios",
    ...
    children: [
      {
        path: "/catalogos",
        name: "catalogos",
        component: () => import("@/views/public/allProducts.vue"),
        meta: {
          pageTitle: "Productos públicos",
          breadcrumbs: ["Catálogos"],
        },
      },
    ],
  },
...
router.beforeEach(async (to) => {
  const publicPages = ["/login", "/catalogos"];
