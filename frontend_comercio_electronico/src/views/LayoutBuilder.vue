    ...
    <div class="card-body d-flex align-items-center py-8">
      ...
      <div class="ms-6">
        <p class="list-unstyled text-gray-600 fw-semibold fs-6 p-0 m-0">
          El creador de diseño lo ayudará a configurar su diseño preferido para
          su proyecto, generar una configuración de diseño y obtener una vista
          previa en tiempo real. Para obtener una vista previa de la
          configuración de diseño predeterminada, simplemente vacíe su
          almacenamiento local o presione el botón 'Restablecer'.
        </p>
      </div>
    </div>
  </div>
